...
| V4_CFG_APIM_CLIENT_ID | APIM Client ID | string | | false | [APIM credentials](https://apiportal.sas.com/get-started) can be obtained from the [APIM Portal](https://developer.sas.com/rest-apis/mysas/docs/getting-started/authentication#obtain-client-credentials) | viya |
| V4_CFG_APIM_CLIENT_SECRET | APIM Client Secret | string | | false | [APIM credentials](https://apiportal.sas.com/get-started) can be obtained from the [APIM Portal](https://developer.sas.com/rest-apis/mysas/docs/getting-started/authentication#obtain-client-credentials) | viya |
